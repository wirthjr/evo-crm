# Evo CRM Community — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "Evo CRM Community" are trademarks of
Evolution Foundation. The "evocrm" wordmark and the Evo CRM Community
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Evo CRM Community trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Evo CRM Community visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Evo CRM Community";
...
(d) any materials that implement or express the Evo CRM Community official look
...
2.1. You may truthfully refer to Evo CRM Community to describe that your software
...
Evo CRM Community that include Evo CRM Community brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Evo CRM Community marks in nominative ways, such as
"based on Evo CRM Community", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Evo CRM Community";
...
Evo CRM Community brand assets.** If you distribute or publicly host any version
of the user interface that uses Evo CRM Community brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Evo CRM Community brand assets.**
...
(a) remove and replace all Evo CRM Community trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Evo CRM Community.

4.3. **No endorsement.**
You may not use Evo CRM Community trademarks or brand assets in a way that
...
Evo CRM Community logo or wordmark.
...
Any violation of this policy terminates your permission to use Evo CRM Community
brand assets. You must promptly cease use and remove Evo CRM Community trademarks
