# Arco CRM Auth Service — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "Arco CRM Auth Service" are trademarks of
Evolution Foundation. The "evoauth" wordmark and the Arco CRM Auth Service
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Arco CRM Auth Service trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Arco CRM Auth Service visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Arco CRM Auth Service";
...
(d) any materials that implement or express the Arco CRM Auth Service official look
...
2.1. You may truthfully refer to Arco CRM Auth Service to describe that your software
...
Arco CRM Auth Service that include Arco CRM Auth Service brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Arco CRM Auth Service marks in nominative ways, such as
"based on Arco CRM Auth Service", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Arco CRM Auth Service";
...
Arco CRM Auth Service brand assets.** If you distribute or publicly host any version
of the user interface that uses Arco CRM Auth Service brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Arco CRM Auth Service brand assets.**
...
(a) remove and replace all Arco CRM Auth Service trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Arco CRM Auth Service.

4.3. **No endorsement.**
You may not use Arco CRM Auth Service trademarks or brand assets in a way that
...
Arco CRM Auth Service logo or wordmark.
...
Any violation of this policy terminates your permission to use Arco CRM Auth Service
brand assets. You must promptly cease use and remove Arco CRM Auth Service trademarks
