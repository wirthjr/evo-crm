# Arco CRM Core Service — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "Arco CRM Core Service" are trademarks of
Evolution Foundation. The "evocrm-core" wordmark and the Arco CRM Core Service
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Arco CRM Core Service trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Arco CRM Core Service visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Arco CRM Core Service";
...
(d) any materials that implement or express the Arco CRM Core Service official look
...
2.1. You may truthfully refer to Arco CRM Core Service to describe that your software
...
Arco CRM Core Service that include Arco CRM Core Service brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Arco CRM Core Service marks in nominative ways, such as
"based on Arco CRM Core Service", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Arco CRM Core Service";
...
Arco CRM Core Service brand assets.** If you distribute or publicly host any version
of the user interface that uses Arco CRM Core Service brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Arco CRM Core Service brand assets.**
...
(a) remove and replace all Arco CRM Core Service trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Arco CRM Core Service.

4.3. **No endorsement.**
You may not use Arco CRM Core Service trademarks or brand assets in a way that
...
Arco CRM Core Service logo or wordmark.
...
Any violation of this policy terminates your permission to use Arco CRM Core Service
brand assets. You must promptly cease use and remove Arco CRM Core Service trademarks
