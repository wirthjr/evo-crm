# Arco Bot Runtime — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "Arco Bot Runtime" are trademarks of
Evolution Foundation. The "evobot" wordmark and the Arco Bot Runtime
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Arco Bot Runtime trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Arco Bot Runtime visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Arco Bot Runtime";
...
(d) any materials that implement or express the Arco Bot Runtime official look
...
2.1. You may truthfully refer to Arco Bot Runtime to describe that your software
...
Arco Bot Runtime that include Arco Bot Runtime brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Arco Bot Runtime marks in nominative ways, such as
"based on Arco Bot Runtime", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Arco Bot Runtime";
...
Arco Bot Runtime brand assets.** If you distribute or publicly host any version
of the user interface that uses Arco Bot Runtime brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Arco Bot Runtime brand assets.**
...
(a) remove and replace all Arco Bot Runtime trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Arco Bot Runtime.

4.3. **No endorsement.**
You may not use Arco Bot Runtime trademarks or brand assets in a way that
...
Arco Bot Runtime logo or wordmark.
...
Any violation of this policy terminates your permission to use Arco Bot Runtime
brand assets. You must promptly cease use and remove Arco Bot Runtime trademarks
